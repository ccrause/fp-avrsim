...
procedure printCommandlineHelp;
  begin
    ...
    writeln('  -6         - Simulate an AVR6 device (18 bit PC). Defaults to 16 bit PC.');
    writeln('  -d<port>   - Start as GDB server and listen on port <port> for a remote connection.');
    writeln('  -h         - Print this help message then exit.');
